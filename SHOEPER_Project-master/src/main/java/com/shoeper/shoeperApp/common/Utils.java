package com.shoeper.shoeperApp.common;
...
public class Utils {
	...
	public static String getPageBar(int totalContents, int cPage, int numPerPage, String url ){
		...
		cPage = cPage==0?1:cPage; // cPage가 0이면 1로 이동
		
		//총페이지수 구하기
		int totalPage = (int)Math.ceil((double)totalContents/numPerPage); // 한페이지 컨텐츠 수 : 12 , 총 컨텐츠 수 : 100 => 총 페이지수 = 9페이지
