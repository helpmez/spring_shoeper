...
<%@ include file="../member/loginModal.jsp"%>
	...
	<header class="header">
		<div class="header_nav">
			...
			<div class="header_logo">
				<img
					src="${pageContext.request.contextPath }/resources/images/shoeper.png"
					id="logo" />
			</div>
			...
			<div class="header_menu">
				<div>
					<h3 id="brand">GET NEW ONE</h3>
				</div>
				<div>
					<h3 id="second_Hand">GET SECOND-HAND ONE</h3>
				</div>
			</div>
					...
					<li class="search_li">
						<div>
							...
							<form action="/header/totalSearch.do" method="POST" id="search_main">
								<input type="text" class="search_input" name="totalSearch"  placeholder="SEARCH"><i class="fas fa-search fa-lg"></i>
							</form>
						</div>
	...
	$(function() {
		...
		/* $('.fa-moon').on('click', function() {
			...
			icon.src = "${pageContext.request.contextPath }/resources/images/shoeper.png";
			icon_footer.src = "${pageContext.request.contextPath }/resources/images/shoeper.png";
