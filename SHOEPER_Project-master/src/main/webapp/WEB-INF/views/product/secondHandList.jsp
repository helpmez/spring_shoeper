                    ...
                    <li id="prod-li">
                        ...
                        <div class="dropArea">
                            <ul class="hiddenArea" id="categoryList">
                                ...
                                <li class="prod cate" id="1">운동화</li>
                                <li class="prod cate" id="2">남성용구두</li>
                                <li class="prod cate" id="3">여성용구두</li>
                                <li class="prod cate" id="4">부츠</li>
                                <li class="prod cate" id="5">샌들</li>
                            </ul>
                        </div> 
                    </li>
                    <br>
