...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
    ...
    <script>
        ...
        $(function() {
        	Kakao.init('73daa7a1f3ca91da275b6b8bfb04cdd4');
        	// SDK 초기화 여부를 판단합니다.
        ...
        //https://kauth.kakao.com/oauth/authorize?client_id=17c639d223474585e39f3abf905f19c8&redirect_uri=http://localhost:8090/shoeperApp/member/snsMemberJoin.do&response_type=code
        //카카오 로그인
            	      			...
            	      			success: function(data){
            	      				...
            	      				if ( data == "" ) {
	      								...
	      								if ( data == id ) {
	      									...
	      									alert("이미 해당 이메일로 가입되어 있는 계정이 존재합니다. 아이디 찾기를 이용해 SHOEPER 계정으로 로그인해주세요.");
	      								}
