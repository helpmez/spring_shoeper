         ...
         <div class="payArea">
               ...
               <div class="paymentSelect">
	               ...
	               <div class ="paymentIcon">    
	                  <label for="samsung">
	                 	 <img src="${pageContext.request.contextPath }/resources/images/orderImg/kakaopay_CI_combination_with_BG.png"/>
	                  </label>
	                </div>
	                <div class ="paymentRadio">
	                  <input type="radio" name="cardradio" id="kakao" value="kakao"/>카카오페이             
             	    </div>
	              </div>
         ...
         <div class="guideDetail">
         	...
         	<div class="detailContent">
	            <ul>
	               ...
	               <li class="lifont">ShoePer는 기본적으로 전 상품 무료 배송입니다.</li>
